...
const config = {
  ...
  philips: {
    $filter: 'env',
    production: {
      password: process.env.PHILIPS_PASSWORD,
      philipsId: process.env.PHILIPS_ID,
      secret: process.env.PHILIPS_SECRET
    },
    $default: {
      password: process.env.PHILIPS_PASSWORD,
      philipsId: process.env.PHILIPS_ID,
  ...
  defaultEmail: {
    $filter: 'env',
    production: null,
    $default: 'sudhansurana@yahoo.co.in'
  },
  system: {
    $filter: 'env',
    production: {
      fromAddress: {
        name: 'hapi-starter',
        address: 'sudhansurana@yahoo.co.in'
      },
      toAddress: {
        name: 'hapi-starter',
        address: 'sudhansurana@yahoo.co.in'
